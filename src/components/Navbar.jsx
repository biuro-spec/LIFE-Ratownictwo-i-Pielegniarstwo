        ...
        {isOpen && (
          ...
          >
            ...
            {serviceLinks.map((link) => (
              <Link
                ...
                className={`text-base font-semibold transition-colors pl-3 border-l-2 ${
                  location.pathname === link.path
                    ? scrolled ? 'text-white font-bold border-white' : 'text-primary-red border-primary-red'
            ...
            <div className="flex flex-col gap-3 mt-4">
              <a
                href="mailto:biuro@life-ratownictwo.pl"
                className={`p-4 rounded-2xl font-bold flex justify-center items-center gap-2 transition-all
                  ${scrolled
                    ? 'bg-white/20 text-white border border-white/30'
                    : 'bg-navy-blue/5 text-navy-blue border border-navy-blue/15'
                  }
                `}
              >
                <Mail size={18} />

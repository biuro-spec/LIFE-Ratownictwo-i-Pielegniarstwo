    ...
    <div>
      ...
      <section className="relative pt-40 pb-24 text-white overflow-hidden">
        <div
          ...
          style={{
            backgroundImage: "linear-gradient(to right, rgba(15,43,70,0.95), rgba(15,43,70,0.8)), url('/assets/images/Life-Ratownictwo-Medyczne-i-Pielegniarstwo.jpg')",
          }}
        />
        <div className="absolute top-0 right-0 w-1/3 h-full bg-primary-red/10 skew-x-12 translate-x-1/4 z-[1]"></div>
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-3xl">
            <span className="bg-green-500/20 text-green-300 font-bold px-5 py-2 rounded-full text-sm inline-flex items-center gap-2 mb-6">
            ...
            <div className="flex flex-wrap gap-4">
              ...
              <a href="#jak-to-dziala" className="bg-white/10 backdrop-blur text-white px-8 py-4 rounded-xl font-bold text-lg border border-white/20 hover:bg-white/20 transition-all">
                Jak to działa?
              </a>
            </div>
          </div>
          <div className="mt-12 flex flex-wrap gap-6">
            {[
              { value: "~10", label: "Przychodni POZ", sub: "w regionie" },
              { value: "100%", label: "Bezpłatnie", sub: "dla uprawnionych" },
              { value: "pon-pt", label: "8:00\u201318:00", sub: "godziny realizacji" },
            ].map((stat, i) => (
